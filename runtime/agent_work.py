#!/usr/bin/env python3
"""What an outside worker may ask for and hand back: the verbs, and nothing about HTTP.

Kept apart from the transport so the ownership rules -- who may claim, what a stale token
may still write -- can be read without a request handler in the way.
"""
